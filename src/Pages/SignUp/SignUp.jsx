            ...
            <div className="hero min-h-screen bg-base-200 pt-10">
                <div className="hero-content flex-col lg:flex-row">
                    ...
                    <div className="card shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
                        ...
                        <p className="text-xs text-center sm:px-6 dark:text-gray-600 pb-10">Already have an account?
                            <Link to="/login" rel="noopener noreferrer" href="#" className="underline dark:text-gray-800 hover:text-blue-600 ml-1">Login</Link>
                        </p>
                    </div>
                </div>
            </div>
